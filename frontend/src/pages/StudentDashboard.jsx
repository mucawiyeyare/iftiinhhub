...
const StudentDashboard = () => {
    ...
    try {
      ...
      const myOwnCerts = rawCerts.filter((c) => {
        ...
        const matchesEmail =
          currentEmail &&
          c.studentEmail &&
          c.studentEmail.toLowerCase().trim() === currentEmail;
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex">
      ...
      {/* Brand Sidebar */}
      <aside
        className={`w-72 bg-white shadow-xl min-h-screen fixed left-0 top-0 z-40 overflow-y-auto transform transition-transform duration-300 ease-in-out border-r border-slate-200 ${
          isMobileMenuOpen
            ? "translate-x-0"
        ...
        <div className="px-6 py-6 border-b-2 border-amber-500 bg-gradient-to-r from-amber-500 via-amber-600 to-orange-600 text-slate-950">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-lg font-black tracking-wide text-slate-950">
                  STUDENT HUB
                </h2>
                <p className="text-[11px] font-bold text-slate-900/80 uppercase tracking-wider">
                  IftiinHub Academy
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                {user?.email || "student@iftiinhub.com"}
              </p>
            </div>
          </div>
        </header>
              ...
              <div className="bg-gradient-to-r from-amber-500 via-amber-600 to-orange-600 rounded-3xl shadow-xl p-8 sm:p-10 text-slate-950 relative overflow-hidden">
                <div className="relative z-10">
                  ...
                  <p className="text-slate-950/80 text-base sm:text-lg max-w-2xl font-medium">
                    You're enrolled in {enrollments.length}{" "}
                    {enrollments.length === 1 ? "course" : "courses"} and have
                    earned {certificates.length} verified{" "}
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      <p className="text-xs text-amber-800 mt-0.5">
                        Instant proof of program completion and professional
                        mastery
                      </p>
                    </div>
                    <button
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {enrollments.slice(0, 3).map((enrollment) => {
                      ...
                      const matchingCert = certificates.find(
                        (c) =>
                          (c.courseId &&
                            String(c.courseId) === String(course._id)) ||
                          (c.courseTitle &&
                            course.name &&
                            (c.courseTitle
                              .toLowerCase()
                              ...
                              course.name
                                .toLowerCase()
                                .includes(c.courseTitle.toLowerCase()))),
                      );

                      return (
                        <div
                          key={enrollment._id}
                          className="bg-white rounded-2xl shadow-sm border border-slate-200/80 flex p-4 gap-4 hover:shadow-md transition cursor-pointer"
                          onClick={() =>
              ...
              <div className="mb-6 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    Access your course videos, training modules, and materials
                  </p>
                </div>
              ...
              {enrollments.length === 0 ? (
                <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-12 text-center">
                  ...
                  <p className="text-slate-500 mb-8 max-w-md mx-auto text-sm">
                    You haven't enrolled in any courses yet. Browse our hands-on
                    professional tracks to get started.
                  </p>
                  <Link
                    to="/courses"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                  {enrollments.map((enrollment) => {
                    ...
                    return (
                      <div
                        key={enrollment._id}
                        className="bg-white rounded-2xl shadow-sm border border-slate-200/80 overflow-hidden hover:shadow-lg transition-all duration-300 flex flex-col group h-full"
                      >
                        <div className="relative overflow-hidden aspect-video">
                          <Link to={`/courses/${course._id}/learn`}>
                            {course.imageUrl ? (
                              ...
                              <div className="w-full h-full bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-slate-950 text-5xl">
                                📚
                              </div>
                            )}
                          </Link>
                          <div className="absolute top-3 right-3 flex flex-col gap-1 items-end">
                            <span
                              className={`px-2.5 py-1 text-xs font-bold rounded-full flex items-center shadow-sm backdrop-blur-md ${
                                enrollment.status === "completed"
            ...
            <div className="animate-fadeIn space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    Official authenticated graduation credentials issued to your
                    account
                  </p>
                </div>
                <Link
              ...
              {certificates.length === 0 ? (
                <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-12 text-center">
                  ...
                  <p className="text-slate-500 mb-8 max-w-md mx-auto text-sm">
                    Certificates are automatically generated and awarded upon
                    completing your training program curriculum and project
                    evaluations.
                  </p>
                  <Link
                    to="/courses"
                      ...
                      <div>
                        ...
                        <div className="space-y-1.5 text-xs text-slate-600 mb-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                          ...
                          <div>
                            ...
                            {cert.instructor || "Eng. Mucawiye & Academic Team"}
                          </div>
                        </div>
                        ...
                        {cert.skills && cert.skills.length > 0 && (
                          <div className="flex flex-wrap gap-1.5 mb-6">
                            {cert.skills.map((skill, idx) => (
                              <span
                                key={idx}
                                className="text-[11px] font-semibold bg-white text-slate-700 px-2.5 py-0.5 rounded-md border border-slate-200 shadow-2xs"
                              >
                                {skill}
                              </span>
                            ))}
                ...
                <div className="p-0">
                  {enrollments.length === 0 ? (
                    <div className="p-12 text-center text-slate-500 flex flex-col items-center">
                      <div className="bg-slate-100 rounded-full p-4 mb-4 text-slate-400 text-3xl">
                        📭
                      </div>
                      ...
                      <p className="text-xs text-slate-500 mt-1">
                        Enroll in a course to see your learning history here.
                      </p>
                    </div>
                  ) : (
                    <div className="divide-y divide-slate-100">
                      {enrollments.map((enrollment) => (
                        <div
                          key={enrollment._id}
                          className="p-6 hover:bg-slate-50 transition flex items-start space-x-4"
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <Link
                              ...
                              className="text-amber-800 hover:text-amber-950 font-bold block mb-1 text-base"
                            >
